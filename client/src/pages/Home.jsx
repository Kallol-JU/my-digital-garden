  ...
  return (
    <div className="animate-fade-in max-w-[650px] pt-12 pb-20">
      ...
      <div className="space-y-4 text-[15px] text-gray-500 leading-relaxed mb-16">
        <p>
          Notes, projects, and loose thoughts from my time as a final year CSE
          student, my work exploring the MERN stack, and things I build on my
          own.
        </p>
        <p>Mostly full-stack web development, machine learning, and ai.</p>
      </div>

      <div className="mb-14">
        <h2 className="text-[11px] font-bold tracking-widest text-gray-500 uppercase mb-6">
          Around Here
        </h2>
      ...
      <div className="mb-16">
        ...
        <div className="flex gap-5 text-gray-400">
          {/* X / Twitter */}
          <a
            href="https://x.com/KallolM69942175"
            target="_blank"
          ...
          {/* Instagram */}
          <a
            href="https://www.instagram.com/whomukherjee/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-gray-900 transition-colors"
          >
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/kallol-mukherjee-444124389/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-gray-900 transition-colors"
          >
          ...
          {/* GitHub */}
          <a
            href="https://github.com/Kallol-JU"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-gray-900 transition-colors"
          >
